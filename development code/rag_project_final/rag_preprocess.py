...
def remove_contents_section(text):
    print("***remove content section***")
    # Define patterns to identify the "Contents" section, "PART", and "CHAPTER"
...
def save_preprocess(preprocess_data):
    ...
    file_path = os.path.join("preprocess_data", "preprocess_data.json")
